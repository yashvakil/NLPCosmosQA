...
#python run_multiway_att.py --task_name commonsenseqa --do_eval --do_train --do_lower_case --bert_model bert-large-uncased --data_dir data/ --max_seq_length 220 --train_batch_size 8 --learning_rate 2e-5  --num_train_epochs 10  --gradient_accumulation_steps=4  --output_dir output/batch_8_lr2e-5__epochs10_seed_42  --seed 42